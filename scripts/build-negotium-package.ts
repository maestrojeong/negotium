...
const packageEntrypoints = new Map<string, string>([
  ...
  ["@negotium/core/runtime-gateway", "packages/core/src/runtime-gateway.ts"],
  ...
  ["@negotium/core/browser-runtime", "packages/core/src/platform/playwright/public-runtime.ts"],
...
for (const entrypoint of [
  ...
  "apps/negotium/src/runtime-gateway.ts",
...
const declarations = Bun.spawn(
  [
    ...
    resolve(root, "packages/core/src/runtime-gateway.ts"),
    ...
    resolve(root, "packages/core/src/platform/playwright/public-runtime.ts"),
